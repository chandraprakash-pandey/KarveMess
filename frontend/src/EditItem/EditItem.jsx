...
import { Plus, Trash2, UtensilsCrossed, Save, ArrowLeft, AlertTriangle, Crown, Sparkles, Star, Zap } from "lucide-react";
...
function EditItem() {
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="flex justify-center mb-6">
                        <div className="inline-flex items-center bg-gradient-to-r from-yellow-400 to-amber-500 px-6 py-3 rounded-full shadow-2xl">
                            ...
                            <span className="text-white font-bold">Premium Menu Editor</span>
                            <Sparkles className="w-5 h-5 text-white ml-2 animate-pulse" />
                        </div>
                    </div>

                    {/* Main Card */}
                    <div className="bg-gradient-to-br from-purple-800 to-indigo-900 shadow-2xl rounded-2xl overflow-hidden border-2 border-yellow-400/30 relative">
                        {/* Animated background effect */}
                        <div className="absolute top-0 right-0 w-96 h-96 bg-yellow-400/10 rounded-full blur-3xl"></div>
                        <div className="absolute bottom-0 left-0 w-64 h-64 bg-yellow-400/5 rounded-full blur-3xl"></div>

                        {/* Header */}
                        <div className="bg-gradient-to-r from-yellow-400 via-amber-500 to-yellow-600 p-8 text-white relative overflow-hidden">
                            <div className="absolute top-0 right-0 w-64 h-64 bg-white opacity-10 rounded-full -mr-32 -mt-32"></div>
                            <div className="absolute bottom-0 left-0 w-48 h-48 bg-white opacity-10 rounded-full -ml-24 -mb-24"></div>
                            
                            <div className="relative z-10">
                                <div className="flex items-center justify-center mb-4">
                                    <div className="w-16 h-16 bg-white bg-opacity-20 rounded-2xl flex items-center justify-center backdrop-blur-sm shadow-lg ring-4 ring-white/30">
                                        <UtensilsCrossed className="w-8 h-8" />
                                    </div>
                                </div>
                                <h2 className="text-3xl font-bold text-center mb-2 flex items-center justify-center">
                                    Edit Premium Menu Items
                                    <Star className="w-6 h-6 ml-2 fill-white animate-pulse" />
                                </h2>
                                <p className="text-center text-yellow-100">Update your exclusive menu offerings</p>
                            </div>
                        </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    {foods.map((food, index) => (
                                        <div
                                            key={index}
                                            className="bg-gradient-to-r from-white/10 to-purple-900/50 backdrop-blur-sm rounded-xl p-5 border-2 border-yellow-400/40 hover:border-yellow-400 hover:shadow-xl transition-all duration-200 hover:scale-102"
                                        >
                                            <div className="flex items-center gap-4">
                                                {/* Item Number Badge */}
                                                <div className="shrink-0 w-10 h-10 bg-gradient-to-br from-yellow-400 to-amber-500 text-white rounded-xl flex items-center justify-center font-bold shadow-lg">
                                                    {index + 1}
                                                </div>
                                                ...
                                                <div className="flex-1">
                                                    <div className="relative">
                                                        ...
                                                        <input
                                                            ...
                                                            className="w-full pl-11 pr-4 py-3 bg-white/10 backdrop-blur-sm border-2 border-white/20 rounded-xl focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400 transition-all outline-none text-white placeholder-purple-200"
                                                            required
                                                        />
                                                    </div>
                                                </div>
                                                ...
                                                <div className="w-36">
                                                    <div className="relative">
                                                        <span className="absolute left-4 top-1/2 transform -translate-y-1/2 text-yellow-400 font-semibold text-lg">
                                                            ₹
                                                        </span>
                                                        <input
                                                            type="number"
                                                            ...
                                                            value={food.price}
                                                            onChange={(e) => handleChange(index, e)}
                                                            className="w-full pl-9 pr-4 py-3 bg-white/10 backdrop-blur-sm border-2 border-white/20 rounded-xl focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400 transition-all outline-none text-white placeholder-purple-200"
                                                            required
                                                            min="0"
                                                            step="0.01"
                                                        />
                                ...
                                <button
                                    type="button"
                                    onClick={addFood}
                                    className="w-full bg-gradient-to-r from-green-500 to-emerald-500 text-white py-4 rounded-xl font-semibold hover:from-green-600 hover:to-emerald-600 transition-all duration-200 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl active:scale-98"
                                >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                                    ...
                                    <button
                                        ...
                                        className={`w-full bg-gradient-to-r from-yellow-400 to-amber-500 text-white py-4 rounded-xl font-bold text-lg transition-all duration-200 flex items-center justify-center gap-2 md:col-span-2 shadow-xl ${
                                            isSubmitting
                                                ? 'opacity-50 cursor-not-allowed'
                                                : 'hover:from-yellow-500 hover:to-amber-600 hover:shadow-2xl active:scale-98 hover:scale-105'
                                        }`}
                                    >
                                        {isSubmitting ? (
                                            <>
                                                <div className="animate-spin rounded-full h-5 w-5 border-t-2 border-white"></div>
                                                Saving Premium Changes...
                                            </>
                                        ) : (
                                            <>
                                ...
                                {/* Info Text */}
                                <div className="bg-gradient-to-r from-yellow-400/20 to-amber-500/20 backdrop-blur-sm border-2 border-yellow-400/30 rounded-xl p-4">
                                    <p className="text-sm text-purple-100 text-center flex items-center justify-center">
                                        <Sparkles className="w-4 h-4 mr-2 text-yellow-400" />
                                        <strong className="text-yellow-400 mr-1">Premium Tip:</strong> Your changes are instantly visible with priority placement!
                                    </p>
                                </div>
                            </form>
                        </div>
                    ...
                    {/* Delete Section - Premium Style */}
                    <div className="mt-8 bg-gradient-to-br from-purple-800 to-indigo-900 shadow-2xl rounded-2xl p-6 border-2 border-red-400/30">
                        <div className="flex items-start gap-4">
                            <div className="shrink-0 w-12 h-12 bg-red-500/20 backdrop-blur-sm rounded-xl flex items-center justify-center border-2 border-red-400/30">
                                <AlertTriangle className="w-6 h-6 text-red-400" />
                            </div>
                            <div className="flex-1">
                                <h3 className="text-lg font-bold text-white mb-1">Danger Zone</h3>
                                <p className="text-sm text-purple-200 mb-4">
                                    Permanently delete this premium item from your menu. This action cannot be undone.
                                </p>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex gap-3">
                                            ...
                                            <button
                                                ...
                                                className="px-6 py-3 bg-white/10 backdrop-blur-sm text-white border-2 border-white/20 rounded-xl font-semibold hover:bg-white/20 transition-all active:scale-95"
                                            >
                                                Cancel
                                            </button>
                                        </div>
                    ...
                    <div className="mt-6 bg-gradient-to-br from-purple-800 to-indigo-900 rounded-2xl p-6 shadow-2xl border-2 border-yellow-400/30">
                        ...
                        <ul className="space-y-2 text-sm text-purple-200">
                            <li className="flex items-start">
                                ...
                                <span>Instant updates with zero downtime</span>
                            </li>
                            <li className="flex items-start">
                                <Star className="w-4 h-4 text-yellow-400 fill-yellow-400 mr-2 mt-0.5" />
                                <span>Priority support for any menu changes</span>
                            </li>
                            <li className="flex items-start">
                                <Star className="w-4 h-4 text-yellow-400 fill-yellow-400 mr-2 mt-0.5" />
                                <span>Advanced analytics on item performance</span>
                            </li>
                            <li className="flex items-start">
                                <Star className="w-4 h-4 text-yellow-400 fill-yellow-400 mr-2 mt-0.5" />
    ...
    // Standard/Free UI (Original Design)
    return (
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                {foods.map((food, index) => (
                                    <div
                                        key={index}
                                        className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl p-5 border-2 border-orange-200 hover:border-orange-300 hover:shadow-md transition-all duration-200"
                                    >
                                        <div className="flex items-center gap-4">
                                            {/* Item Number Badge */}
                                            <div className="shrink-0 w-10 h-10 bg-gradient-to-br from-orange-500 to-red-500 text-white rounded-xl flex items-center justify-center font-bold shadow-md">
                                                {index + 1}
                                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                                ...
                                <button
                                    type="submit"
                                    disabled={isSubmitting}
                                    className={`w-full bg-gradient-to-r from-orange-500 to-red-500 text-white py-4 rounded-xl font-bold text-lg transition-all duration-200 flex items-center justify-center gap-2 md:col-span-2 ${
                                        isSubmitting
                                            ? 'opacity-50 cursor-not-allowed'
